...
└─────────────────┘    └─────────────────┘    └─────────────────┘    └─────────────────┘
         ...
         └─────────────────────────────────────────────────────────────────────────────┘
                  ...
                  v                  v                  v                  v
         ┌─────────────┐    ┌─────────────┐    ┌─────────────┐    ┌─────────────┐
         │ AI ENGINE   │    │ ANALYTICS   │    │  MONGODB    │    │ MONITORING  │
         │             │    │             │    │             │    │             │
         │• Threat Det │    │• Real-time  │    │• Collections│    │• Prometheus │
         │• ML Models  │    │• Dashboards │    │• Indexes    │    │• Grafana    │
         │• Features   │    │• Metrics    │    │• Replication│    │• Alerts     │
         └─────────────┘    └─────────────┘    └─────────────┘    └─────────────┘
```

📊 **Detailed System Design**: [View Complete Architecture](docs/system-design.md)
...
### Threat Intelligence
The system includes comprehensive threat detection datasets:
- **Malware Domains**: URLhaus and community feeds
- **Phishing Sites**: PhishTank and security research
- **Ad/Tracker Blocking**: Steven Black's unified hosts
- **Ransomware Domains**: Active threat campaigns

### Performance Optimization
- **Popular Domains**: Tranco top 10,000 domains for cache preloading
- **Typo Patterns**: Common misspellings of popular sites
- **Geographic Data**: Optional GeoIP for location-based responses
...
./scripts/load-datasets.sh threats
./scripts/load-datasets.sh popular
./scripts/load-datasets.sh typos
```
...
- **Redis**: Distributed caching and real-time analytics
